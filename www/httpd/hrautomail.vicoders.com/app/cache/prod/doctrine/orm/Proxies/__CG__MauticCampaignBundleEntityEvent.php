...
class Event extends \Mautic\CampaignBundle\Entity\Event implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'id', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'name', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'description', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'type', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'eventType', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'order', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'properties', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'triggerDate', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'triggerInterval', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'triggerIntervalUnit', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'triggerMode', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'campaign', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'children', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'parent', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'decisionPath', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'tempId', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'log', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'contactLog', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'channel', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'channelId', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Event' . "\0" . 'changes');
        }
