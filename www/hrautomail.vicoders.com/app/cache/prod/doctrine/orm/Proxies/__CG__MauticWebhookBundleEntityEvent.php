...
class Event extends \Mautic\WebhookBundle\Entity\Event implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\WebhookBundle\\Entity\\Event' . "\0" . 'id', '' . "\0" . 'Mautic\\WebhookBundle\\Entity\\Event' . "\0" . 'webhook', '' . "\0" . 'Mautic\\WebhookBundle\\Entity\\Event' . "\0" . 'queues', '' . "\0" . 'Mautic\\WebhookBundle\\Entity\\Event' . "\0" . 'eventType');
        }
