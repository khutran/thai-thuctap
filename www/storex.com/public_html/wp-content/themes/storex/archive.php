			...
			<?php if (!$boxed || $boxed=='') : ?><div class="container"><?php endif; ?>
				...
				<div class="col-md-4 col-sm-4 col-sx-12">
					<h1 class="title">
							<?php
								if ( is_day() ) :
									printf( esc_html__( 'Daily Archives: %s', 'storex' ), get_the_date() );
										elseif ( is_month() ) :
									printf( esc_html__(  'Monthly Archives: %s', 'storex' ), get_the_date( esc_html_x( 'F Y', 'monthly archives date format', 'storex' ) ) );
										elseif ( is_year() ) :
									printf( esc_html__( 'Yearly Archives: %s', 'storex' ), get_the_date( esc_html_x( 'Y', 'yearly archives date format', 'storex' ) ) );
								else :
									esc_html_e( 'Archives', 'storex' );
								endif;
							?>
					</h1>    
				</div>
