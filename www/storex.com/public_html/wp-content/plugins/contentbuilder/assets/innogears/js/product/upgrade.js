...
(function($) {
	...
	// Declare methods for InnoGears Update class
	IG_Upgrade.prototype = {
		install: function() {
		...
		step2: function () {
			...
			$.getJSON(
				$(this.button).attr('data-source') + '?action=ig-check-edition' + '&' + 'id=' + this.params.identified_name + '&' + 'edition=' + this.params.edition + '&' + $(document.JSNUpgradeLogin).serialize(),
		...
		step3: function() {
			...
			$.ajax({
				url: $(this.button).attr('data-source') + '?action=ig-download-update' + '&' + 'id=' + this.params.identified_name + '&' + 'edition=' + $('select', document.JSNUpgradeLogin).val(),
		...
		step4: function() {
			...
			$.ajax({
				url: $(this.button).attr('data-source') + '?action=ig-install-update' + '&' + 'id=' + this.params.identified_name + '&' + 'edition=' + $('select', document.JSNUpgradeLogin).val(),
				context: this
			}).done(function(data) {
